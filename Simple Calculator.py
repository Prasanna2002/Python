...
b_percent=Button(d,text='%',padx=44,pady=20,bg='black',fg='white',relief=GROOVE,command =lambda:e_get('0'))
...
b_CE.grid(column=1,row=1) #print(1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111)
...
b_percent.config(state=DISABLED)
